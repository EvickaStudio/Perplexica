...
4. Create your configuration file by running:
   ```bash
   npm run setup
   ```
   This will create a `config.toml` file from the sample configuration. For Docker setups, you need only fill in the following fields:
