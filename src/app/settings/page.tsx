...
import OpenRouterWidget from '@/components/OpenRouterWidget';
import { Select as EnhancedSelect } from '@/components/ui/Select';
import OpenRouterProviderSelector from '@/components/OpenRouterProviderSelector';
        ...
        {isLoading ? (
          ...
          config && (
            <div className="flex flex-col space-y-6 pb-28 lg:pb-8">
                    ...
                    {selectedChatModelProvider === 'openrouter' &&
                      selectedChatModel && (
                        <OpenRouterProviderSelector
                          ...
                          selectedProvider={
                            selectedOpenRouterProvider || undefined
                          }
                          onProviderChange={(provider) => {
                            setSelectedOpenRouterProvider(provider);
                            // You can save this to config if needed
                            // saveConfig('openRouterProvider', provider);
                          }}
                        />
                      )}
                  </div>
              ...
              <SettingsSection title="OpenRouter Account">
                <OpenRouterWidget />
              </SettingsSection>

              {/* Admin-only sections */}
              {session?.user && Boolean((session.user as any).isAdmin) && (
                <>
                  <SettingsSection title="User Management">
                    <RegistrationToggle />
                  </SettingsSection>

                  <SettingsSection title="API Key Management">
                    <ApiKeySection />
                  </SettingsSection>
                </>
              )}
                  ...
                  <div className="flex flex-col space-y-4">
                    ...
                    <div className="flex flex-col space-y-1">
                      ...
                      <Input
                        ...
                        onSave={(value) =>
                          saveConfig('openrouterApiKey', value)
                        }
                      />
                    </div>
                  </div>
